...
public final class ConfigManager {
	...
	public Map<String, Object> getConfig ( int type ) {
		...
		if(this.jsonConfig.get("userId") != null){
...
//		String configContent = this.filter(this.getClass().getClassLoader().getResourceAsStream("static/ueditor/config.json"));
		InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("goushi/config.json");
...
//		String configContent = this.readFile( this.getConfigPath() );
	...
	private String getConfigPath ()  {
		try{
			ClassPathResource classPathResource =  new ClassPathResource("goushi/config.json");
